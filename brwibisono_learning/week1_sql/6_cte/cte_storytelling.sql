...
avg_revenue AS (
  SELECT AVG(total_revenue) AS rata2_revenue_produk
...
SELECT
  ...
  ROUND(a.rata2_revenue_produk, 2) AS rata2_revenue_produk,

  ROUND(r.total_revenue - a.rata2_revenue_produk, 2) AS selisih_produk_vs_rata2,

  ROUND((r.total_revenue / c.total_revenue_kategori) * 100, 2) AS kotribusi_produk_dalam_kategori
